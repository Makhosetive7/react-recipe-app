...
const PopularCocktails = ({imageurl,  alcoholic, typeOfGlass, category, title}) => {
  ...
  return (
    <Container>
        <TopInformation>
            <Btn>Cocktail Instructions || Recipes</Btn>
        </TopInformation>
        ...
        <BottomInformation>
            <h1>{title} || {alcoholic}</h1>
            <h2> {typeOfGlass}    ||   {category} </h2>
        </BottomInformation>
    </Container>
